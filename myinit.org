...
*** LSP Mode
:PROPERTIES:
:ID:       03d1e67f-6c54-11ef-90dc-3417ebb05b4f
:END:
...
(setq lsp-ui-doc-enable nil            ; Stop automatic hover popups
      lsp-ui-sideline-enable nil)      ; Stop diagnostics/info in the right margin

;; Crucially, disable automatic hover on cursor/mouse movement:
(setq lsp-ui-doc-show-with-mouse nil
      lsp-ui-doc-show-with-cursor nil) ; This prevents many `textDocument/hover` cancellations
#+end_export
**** Py-autopep8
